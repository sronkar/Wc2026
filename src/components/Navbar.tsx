      ...
      <div className="max-w-6xl mx-auto px-4 flex items-center justify-between h-14">
        ...
        >
          ...
          <svg width="30" height="30" viewBox="0 0 30 30" fill="none" aria-hidden>
            ...
            <path d="M 18.7,20.7 L 23.8,25.5 L 30.9,18.4" stroke="rgba(255,255,255,0.88)" strokeWidth="3.0" strokeLinecap="round" strokeLinejoin="round" fill="none"/>
            <path d="M 18.7,20.7 L 23.8,25.5 L 30.9,18.4" stroke="#C9A84C" strokeWidth="2.0" strokeLinecap="round" strokeLinejoin="round" fill="none"/>
