  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-8">
      <div className="mb-6">
        ...
        <h1 className="text-2xl font-bold text-gray-900 mt-1">All Matches</h1>
        <p className="text-gray-400 text-sm">104 games · your predictions are saved for this group</p>
      </div>
